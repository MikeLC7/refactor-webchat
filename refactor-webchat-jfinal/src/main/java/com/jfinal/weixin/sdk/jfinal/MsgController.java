...
public abstract class MsgController extends Controller {
    ...
    /**
     *
     * Description: 输出消息通用入口
     *
     * @author: MikeLC
     *
     * @date: 2017/11/22 下午 05:00
     */
    public void renderForAll(OutMsg outMsg) {
        //
        String contentType = "text/xml";
        if(outMsg instanceof OutImageMsg){
            contentType = "image/xml";
        }else if(outMsg instanceof OutVoiceMsg){
            contentType = "voice/xml";
        }else if(outMsg instanceof OutVideoMsg){
            contentType = "video/xml";
        }else if(outMsg instanceof OutMusicMsg){
            contentType = "music/xml";
        }else if(outMsg instanceof OutNewsMsg){
            contentType = "news/xml";
        }
        //
        ...
        this.renderText(outMsgXml, contentType);
    }
