...
import com.refactor.webchat.rest.webchat.msg.WebChatMsgController;
import org.springframework.context.annotation.Configuration;

@Configuration
public class WebChatConfig extends JFinalConfig {
    // 本地开发模式
    private boolean isLocalDev = false;

    {
        loadProp("webchat_config_pro.txt", "webchat_config.txt");
        this.afterJFinalStart();
    }
    ...
    public void configRoute(Routes me) {
        me.add("/webchatOrg/msg", WebChatMsgController.class);
...
//        }
        ...
        wc.setAppId(PropKit.get("appet_appId"));
        wc.setAppSecret(PropKit.get("appet_appSecret"));
